...
import com.ochenjoshua.ojmusicplayer.ui.utils.getMusicVideoYTThumbnail
...
object DiscordImageResolver {
    ...
    fun buildImageUrl(
        ...
        when (imageType.lowercase()) {
            ...
            "appicon" -> {
                "https://raw.githubusercontent.com/MuwMx/OJ Music Player/main/assets/ic_launcher.webp" // legacy icon path not yet migrated to fastlane
            }
