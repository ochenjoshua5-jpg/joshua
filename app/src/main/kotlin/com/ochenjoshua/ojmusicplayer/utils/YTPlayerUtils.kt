...
import com.ochenjoshua.ojmusicplayer.innertube.pages.NewPipeUtils
...
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_TESTSUITE
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_UNPLUGGED
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.IOS
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.IOS_MUSIC
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.IPADOS
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.MOBILE
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.TVHTML5
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.VISIONOS
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.WEB
import com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
import com.ochenjoshua.ojmusicplayer.utils.potoken.BotGuardTokenGenerator
...
object YTPlayerUtils {
     ...
     *
     * [com.ochenjoshua.ojmusicplayer.innertube.models.YouTubeClient.WEB_REMIX] should be preferred here because currently it is the only client which provides:
    ...
    private data class CachedPoToken(
        val playerToken: String,
        val sessionToken: String,
        val expiresAtMs: Long
    )
    private val poTokenCache = ConcurrentHashMap<String, CachedPoToken>()
    private const val PO_TOKEN_VALIDITY_MS = 10 * 60 * 1000L // 10 минут (безопасный запас)

    private fun getCachedPoToken(sessionId: String): CachedPoToken? {
    ...
    private fun cachePoToken(sessionId: String, playerToken: String, sessionToken: String) {
...
//        }
        ...
        if (metadataClient.useWebPoTokens && sessionId != null) {
            // 🔥 ПРОВЕРЯЕМ КЭШ
            val cachedToken = getCachedPoToken(sessionId)
            if (cachedToken != null) {
                ...
                try {
                    ...
                    metadataPoToken = tokenResult?.playerToken
                    tokenResult?.let {
                        cachePoToken(sessionId, it.playerToken, it.sessionToken) // Сохраняем в кэш
                        YouTube.authState = YouTube.authState.copy(
                            poTokenGvs = it.sessionToken,
                            poTokenPlayer = it.playerToken,
                            webClientPoTokenEnabled = true,
...
//            }
            ...
            if (metadataClient.useWebPoTokens && newSessionId != null) {
                val cachedRetryToken = getCachedPoToken(newSessionId)
                if (cachedRetryToken != null) {
                    ...
                    try {
                        ...
                        metadataPoToken = tokenResult?.playerToken
                        tokenResult?.let {
                            cachePoToken(newSessionId, it.playerToken, it.sessionToken)
                            YouTube.authState = YouTube.authState.copy(
                                poTokenGvs = it.sessionToken,
                                poTokenPlayer = it.playerToken,
                                webClientPoTokenEnabled = true,
        ...
        if (MAIN_CLIENT.useWebPoTokens && sessionId != null) {
            ...
            if (cachedToken != null) {
                ...
                try {
                    ...
                    tokenResult?.let {
                        cachePoToken(sessionId, it.playerToken, it.sessionToken)
                        YouTube.authState = YouTube.authState.copy(
                            poTokenGvs = it.sessionToken,
                            poTokenPlayer = it.playerToken,
                            webClientPoTokenEnabled = true,
