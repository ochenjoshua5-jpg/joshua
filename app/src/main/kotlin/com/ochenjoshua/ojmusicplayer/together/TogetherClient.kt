...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.ochenjoshua.ojmusicplayer.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: com.ochenjoshua.ojmusicplayer.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.ochenjoshua.ojmusicplayer.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.ochenjoshua.ojmusicplayer.together.JoinDecision -> {
                            ...
                            is com.ochenjoshua.ojmusicplayer.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
