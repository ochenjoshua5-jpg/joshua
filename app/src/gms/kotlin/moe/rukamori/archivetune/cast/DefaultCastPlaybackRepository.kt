...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): com.ochenjoshua.ojmusicplayer.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return com.ochenjoshua.ojmusicplayer.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    com.ochenjoshua.ojmusicplayer.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
