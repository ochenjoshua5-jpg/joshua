...
package com.ochenjoshua.ojmusicplayer.lastfm
...
import com.ochenjoshua.ojmusicplayer.lastfm.models.LastFmError
import com.ochenjoshua.ojmusicplayer.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "OJ Music Player (https://github.com/MuwMx/OJ Music Player)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
