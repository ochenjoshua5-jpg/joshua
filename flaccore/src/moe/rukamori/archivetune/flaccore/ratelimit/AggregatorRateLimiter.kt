package com.ochenjoshua.ojmusicplayer.flaccore.ratelimit
        ...
        mutex.withLock {
            ...
            if (bucket.rateLimitTimestamps.size >= 5) {
                ...
                if (newRate < cfg.tokensPerSecond) {
                    ...
                    logger.i("AggregatorRateLimiter: $sourceId 429-rate-limited 5+ times in 60s; halving rate to $newRate tokens/sec")
